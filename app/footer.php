...
<footer class="glass-effect-footer py-16 px-6 mt-20 rounded-t-6xl modern-border">
    <div class="container mx-auto">
        ...
        <div class="flex justify-center mt-8 space-x-6 text-sm text-light/70">
            <a href="cgu.php" class="hover:text-accent transition-colors">
                Conditions Générales d'Utilisation
            </a>
            <span class="text-light/30">|</span>
            <a href="mentions-legales.php" class="hover:text-accent transition-colors">
                Mentions Légales
            </a>
        </div>
