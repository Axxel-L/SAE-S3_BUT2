...
?>
    ...
    <section id="accueil" class="py-32 px-6 hero-bg relative overflow-hidden" style="padding-top: 10rem;">
        <div class="container mx-auto text-center relative z-10">
            <div class="floating-element inline-block mb-10">
                <div
                    class="glass-card rounded-full p-8 w-40 h-40 mx-auto flex items-center justify-center modern-border">
            ...
            <div class="typewriter text-2xl md:text-3xl max-w-3xl mx-auto mb-16 text-light/80">
                Célébrons l'<span class="text-accent font-medium">excellence</span> et l'<span
                    class="text-accent font-medium">innovation</span> du jeu vidéo
            </div>
            <div class="flex flex-col md:flex-row justify-center gap-6">
                <a href="#presentation"
                    class="glass-button px-12 py-5 rounded-3xl text-xl font-medium flex items-center justify-center space-x-3 modern-border">
    ...
    <section id="presentation" class="py-28 px-6">
        <div class="container mx-auto">
            <h2 class="text-5xl font-bold text-center mb-20 font-orbitron section-title text-light">Présentation du site
            </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div class="glass-card rounded-5xl p-12 modern-border">
                    ...
                    <p class="text-xl mb-6 text-light/80 leading-relaxed">
                        Créer une plateforme technique innovante dédiée aux organisateurs d'événements gaming, leur
                        offrant une solution complète et fiable pour gérer des procédures de vote électronique.
                    </p>
                    <div class="space-y-4 mt-8">
                        <div class="flex items-start">
                            <div
                                class="flex-shrink-0 w-8 h-8 rounded-full bg-accent/20 flex items-center justify-center mr-4 mt-1">
                ...
                <div class="glass-card rounded-5xl p-12 modern-border">
                    ...
                    <p class="text-xl mb-6 text-light/80 leading-relaxed">
                        Face à la digitalisation accélérée du secteur, les organisateurs d'événements gaming recherchent
                        des outils spécialisés capables de répondre à leurs exigences uniques.
                    </p>
                    <div class="space-y-4 mt-8">
                        <div class="flex items-start">
                            <div
        ...
        <div class="container mx-auto">
            ...
            <div class="glass-card rounded-5xl p-12 max-w-5xl mx-auto modern-border fade-in">
                ...
                <p class="text-xl mb-8 text-light/80 leading-relaxed">
                    Notre système de vote se déroule en deux phases distinctes qui permettent de déterminer d'abord les
                    meilleurs jeux par catégorie, puis le jeu ultime de l'année.
                </p>

                <div class="mb-12">
                    <h4 class="text-2xl font-bold mb-6 font-orbitron text-light border-b border-accent/30 pb-2">Étape 1
                        : Vote par catégorie</h4>
                    <p class="text-xl mb-6 text-light/80 leading-relaxed">
                        Lors de nos événements, les utilisateurs votent pour leurs jeux favoris dans chaque catégorie.
                    ...
                    <ul class="text-lg text-light/80 mb-8 space-y-4">
                        <li class="flex items-start">
                            ...
                            <span>Parcourez les différentes catégories (meilleur gameplay, graphismes, narration,
                                etc.)</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check text-accent mt-1 mr-3"></i>
                    ...
                    <p
                        class="text-lg text-light/80 italic bg-gradient-to-r from-accent/10 to-transparent p-4 rounded-3xl">
                        Un seul jeu est élu par catégorie et devient finaliste pour la grande finale.
                    </p>
                </div>

                <div class="mb-12">
                    <h4 class="text-2xl font-bold mb-6 font-orbitron text-light border-b border-accent/30 pb-2">Étape 2
                        : Élection du jeu de l'année</h4>
                    <p class="text-xl mb-6 text-light/80 leading-relaxed">
                        Une fois les catégories déterminées, la seconde phase de vote débute pour élire le meilleur jeu
                        de l'année :
                    </p>
                    <ul class="text-lg text-light/80 mb-8 space-y-4">
                        <li class="flex items-start">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mt-12">
                    <div class="text-center">
                        <div
                            class="glass-button rounded-3xl p-6 mb-6 mx-auto w-24 h-24 flex items-center justify-center modern-border">
                        ...
                        <p class="text-lg text-light/80">Sélectionnez votre jeu préféré dans chaque catégorie lors de la
                            première étape.</p>
                    </div>
                    <div class="text-center">
                        <div
                        ...
                        <p class="text-lg text-light/80">Les gagnants de chaque catégorie deviennent finalistes pour le
                            titre suprême.</p>
                    </div>
                    <div class="text-center">
                        <div
                        ...
                        <p class="text-lg text-light/80">Élisez le meilleur jeu de l'année parmi les finalistes lors de
                            la seconde étape.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div class="glass-card rounded-4xl p-8 modern-border">
                    ...
                    <form id="contactForm" class="space-y-6">
                        ...
                        <div>
                            <label for="email" class="block mb-2 font-medium text-light">Adresse email *</label>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-light/80">11 Rue de l'Université, <br>88100 Saint-Dié-des-Vosges, France
                                </p>
                            </div>
                        </div>
