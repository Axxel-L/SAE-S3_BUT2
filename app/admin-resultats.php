        ...
        <?php if ($event): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div class="glass-card rounded-3xl p-6 modern-border border-2 border-white/10 text-center">
                    ...
                    <div class="text-light-80 text-sm"><i class="fas fa-users mr-1"></i>Votants inscrits</div>
                </div>
                <div class="glass-card rounded-3xl p-6 modern-border border-2 border-white/10 text-center">
                    <div class="text-3xl font-bold text-accent mb-2"><?php echo $stats['total_votes_cat']; ?></div>
                    <div class="text-light-80 text-sm"><i class="fas fa-vote-yea mr-1"></i>Votes (catégories)</div>
                </div>
                <div class="glass-card rounded-3xl p-6 modern-border border-2 border-white/10 text-center">
                    <div class="text-3xl font-bold text-accent mb-2"><?php echo $stats['total_votes_final']; ?></div>
                    <div class="text-light-80 text-sm"><i class="fas fa-crown mr-1"></i>Votes (finale)</div>
                </div>
            </div>
            <!-- Résultats par catégorie -->
            <div class="mb-12">
                ...
                <?php if (empty($resultatsCat)): ?>
                    <div class="glass-card rounded-3xl p-8 modern-border border-2 border-white/10 text-center">
                        <p class="text-light-80">Aucun vote pour le moment.</p>
                    </div>
                <?php else: ?>
                    <div class="space-y-8">
            ...
            <div>
                ...
                <?php if (empty($resultatsFinal)): ?>
                    <div class="glass-card rounded-3xl p-8 modern-border border-2 border-white/10 text-center">
                        <p class="text-light-80">Aucun vote final pour le moment.</p>
                    </div>
                <?php else: ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        ?>
                            <div class="glass-card rounded-2xl p-6 modern-border border border-white/10">
                                ...
                                <div class="mb-3 p-3 rounded-2xl bg-accent/10 border border-accent/20">
                                ...
                                <div class="text-xs text-light-80 mt-2 text-center"><?php echo round($percentage, 1); ?>%</div>
                            </div>
                        <?php endforeach; ?>
                    </div>
                <?php endif; ?>
